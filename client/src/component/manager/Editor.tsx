...
function Editor({ info, setInfo, show, setShow, onHide }: InfoProps) {
  ...
  return (
    ...
    <Modal show={show} onHide={handleClose}>
        ...
        <InputGroup.Text id="basic-addon1">회사명</InputGroup.Text>
        <Form.Control
      ...
      <InputGroup className="mb-3">
      <InputGroup.Text id="basic-addon2">구직사이트 주소</InputGroup.Text>
        <Form.Control
      ...
      <InputGroup className="mb-3">
      <InputGroup.Text id="basic-addon2">구직사이트 주소</InputGroup.Text>
        <Form.Select aria-label="HuntingSite" defaultValue={info.huntingSite} onSelect={onSelect}>
      ...
      <InputGroup className="mb-3">
      <InputGroup.Text id="basic-addon2">직원 수</InputGroup.Text>
        <Form.Control
      ...
      <InputGroup className="mb-3">
      <InputGroup.Text id="basic-addon2">요구 경력</InputGroup.Text>
        <Form.Select aria-label="RequiredCareer" defaultValue={info.requiredCareer} onSelect={onSelect}>
      ...
      <InputGroup className="mb-3">
        ...
        <Form.Control aria-label="Salary" placeholder={info.salary}/>
        <InputGroup.Text>만원</InputGroup.Text>
      </InputGroup>

      <InputGroup className="mb-3">
        <InputGroup.Text>근무지 위치</InputGroup.Text>
        <Form.Control aria-label="Location" placeholder={info.location}/>
      </InputGroup>

      <InputGroup className="mb-3">
        <InputGroup.Text>지원일</InputGroup.Text>
        <Form.Control aria-label="Date" placeholder={info.applyDate}/>
      </InputGroup>
